...
try{Object.defineProperties(window,{
  MAX_LENGTHS:{get(){return MAX_LENGTHS},configurable:true},
  esc:{get(){return esc},configurable:true},
  escapeHTML:{get(){return escapeHTML},configurable:true},
  overLimit:{get(){return overLimit},configurable:true},
  sanitizeURL:{get(){return sanitizeURL},configurable:true}
})}catch(e){console.error('bridge',e)}
export {MAX_LENGTHS, esc, escapeHTML, overLimit, sanitizeURL};
